The pipeline executed successfully. Both output files have been generated and validated. Here is the complete `data_pipeline.py`:
...
```
✓ cleaned_data.csv written (200 rows, 19 columns)
✓ summary_stats.csv written (24 rows, 12 columns)

=== Overall KPIs ===
Total Orders:        200
Total Units Sold:    493
Total Gross Revenue: $51,070.07
Total Net Revenue:   $45,729.80
Total Shipping Cost: $3,446.86
Total Net Profit:    $42,282.93
Avg Order Value:     $228.65
Avg Profit Margin:   63.08%
Avg Discount:        10.00%
...
**Validation Summary:**
- `cleaned_data.csv`: 200 rows × 19 columns ✓ (all columns match Section 4.2)
- `summary_stats.csv`: 24 rows × 12 columns ✓ (all levels present: 1 overall + 4 category + 4 region + 3 segment + 12 months)
- No null values ✓
- All quantities and unit prices positive ✓
- All net revenues non-negative ✓
- All floats rounded to 2 decimal places ✓
- Sorted by order_date then order_id ✓
- Summary sorted by group_level then group_name ✓